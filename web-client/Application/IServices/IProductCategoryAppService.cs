...
public interface IProductCategoryAppService
{
    ...
    Task<BaseProcess<IEnumerable<ProductCategoryItemResponse>>> GetAllTopLevelAsync();
    Task<BaseProcess<IEnumerable<ProductCategoryItemResponse>>> GetAllTopLevelShowHomeAsync();
